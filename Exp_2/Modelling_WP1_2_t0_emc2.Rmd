...
mapped_par(p_vector, design_exp2_v3_t0)
```
...
plot_prior(prior = prior_exp2_v3_t0, design = design_exp2_v3_t0,layout=c(3,3))
```            
...
LBA_exp2_v3_t0 <- fit(LBA_exp2_v3_t0, cores_per_chain = 3, fileName="models/tmp.RData",
                     iter = 10000, step_size = 500)
save(LBA_exp2_v3_t0,file="models/LBA_exp2_v3_t0.RData") 
...
save(pp_LBA_exp2_v3_t0,file="models/pp_LBA_exp2_v3_t0.RData")
