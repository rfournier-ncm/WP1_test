...
array_theta_pid_2 <- array_theta_2 %>%
  pivot_longer(cols = c("v_SNew_lMTRUE", "v_SNew_lMFALSE", "v_SFamous_lMFALSE", "v_SFamous_lMTRUE", "sv_lMTRUE", "B_lRNew", "B_lRFamous", "A_lRNew", "A_lRFamous", "t0"), names_to = "param", values_to = "value")%>%
...
drift_rate_pid_2 <- array_theta_pid_2 %>% 
  ...
  mutate(condition = if_else(str_detect(param, "New"), "Novel", "Famous"),
