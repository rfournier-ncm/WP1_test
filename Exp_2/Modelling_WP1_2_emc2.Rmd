...
```{r}
design_exp2_v1 <- design(data = data_emc,model=LBA,matchfun=matchfun,
...
prior_exp2_v1 <- prior(design_exp2_v1, type ='standard',mu_mean=mu_mean,mu_sd=mu_sd)
...
```{r}
LBA_exp2_v1 <- make_emc(data_emc,design_exp2_v1,type="standard",  prior=prior_exp2_v1)
LBA_exp2_v1 <- fit(LBA_exp2_v1, cores_per_chain = 2, fileName="Exp_2/models/tmp.RData",
                     iter = 10000, step_size = 500)
save(LBA_exp2_v1,file="Exp_2/models/LBA_exp2_v1.RData") 
...
save(pp_LBA_exp2_v1,file="Exp_2/models/pp_LBA_exp2_v1.RData")
