...
data_exp2 <- read_csv(here(
  "exp_2", "data", "data_exp_2", "wrangle_data_exp_2.csv"
)) |>
...
# Extract scalars for inline text from the table
# Exp 1
...
male_exp1          <- exp1_row$Men
female_exp1        <- exp1_row$Women
...
male_exp2          <- exp2_row$Men
female_exp2        <- exp2_row$Women
...
male_exp3          <- exp3_row$Men
female_exp3        <- exp3_row$Women
...
male_exp4            <- exp4_row$Men
female_exp4          <- exp4_row$Women
...
thresh_all <- theta_all |>
  ...
  mutate(
    ...
    response   = factor(response, levels = c("novel", "learned", "famous"))
