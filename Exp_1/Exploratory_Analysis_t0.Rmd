...
```{r}
#Preregistered model
load("Exp_1/models/LBA_exp2_v1_t0.RData")
```
...
array_theta_pid_1 <- array_theta_1 %>%
  pivot_longer(cols = c("v_Sunf_lMTRUE", "v_Sunf_lMFALSE", "v_Sfam_lMTRUE", "v_Sfam_lMFALSE", "sv_lMTRUE", "B_lRunf", "B_lRfam", "A", "t0_Sunf", "t0_Sfam"), names_to = "param", values_to = "value")%>%
...
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1_git/EMC_WP1_1/figures/all_params_1_t0.jpeg",
       width = 8, height = 6)
```
...
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1_git/EMC_WP1_1/figures/all_params_pid_1_t0.jpeg",
       width = 8, height = 6)
```
...
## save a figure
 ggsave("/Users/rfournier/Rstudio/EMC_WP1_1_git/EMC_WP1_1/figures/thresh_t0.jpeg",width = 10, height = 6)
```
