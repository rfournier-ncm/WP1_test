...
LBA_exp2_v2_bias <- fit(LBA_exp2_v2_bias, cores_per_chain = 3, fileName="Exp_2/models/tmp.RData",
                     iter = 10000, step_size = 500)
save(LBA_exp2_v2_bias,file="Exp_2/models/LBA_exp2_v2_bias.RData") 
...
save(pp_LBA_exp2_v2_bias,file="Exp_2/models/pp_LBA_exp2_v2_bias.RData")
plot_fit(data_emc, pp_LBA_exp2_v2_bias, factors = c("S"),layout=c(1,2))
```
