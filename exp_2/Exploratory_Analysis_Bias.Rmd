...
#Bias model
param_2_pid = EMC2::parameters(LBA_exp2_v2_bias, selection = "alpha", N = NULL, resample = TRUE)
```
...
## save a figure
 ggsave("Exp_2/figures/thresh_bias.jpeg",width = 10, height = 6)
```
...
# save a figure
 ggsave("Exp_2/figures/thresh2_bias.jpeg",
        width = 21, height = 10)
```
...
# save a figure
ggsave("Exp_2/thresh2_2_bias.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("Exp_2/figures/thresh2_3.jpeg",
       width = 21, height = 10)
```
...
ggsave("Exp_2/figures/drift_rate_2_bias.jpeg",
        width = 10, height = 6)
```
...
```{r}
p4.1 / p4.2
ggsave("Exp_2/figures/drift_rate_true_false_2_bias.jpeg", 
       width = 16, height = 13)
```
...
# save a figure
ggsave("Exp_2/figures/drift_rat_mini_2_bias.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("Exp_2/figures/drift_rate_pid_2_bias.jpeg",
       width = 15, height = 10)
```
...
bias_pid <- array_theta_pid_2 %>% 
  ...
  mutate(response = if_else(str_detect(param, "lRNew"), "Novel", "Famous"),
         response = factor(response,
                            levels = c("Novel", "Famous")))
head(bias_pid)
str(bias_pid)
...
## save a figure
 ggsave("Exp_2/figures/bias_2_bias.jpeg",width = 10, height = 6)
```
...
# save a figure
 ggsave("Exp_2/figures/bias_2_2_bias.jpeg",
        width = 21, height = 10)
```
...
# save a figure
ggsave("Exp_2/figures/bias2_2.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("Exp_2/figures/bias2_3.jpeg",
       width = 21, height = 10)
```
