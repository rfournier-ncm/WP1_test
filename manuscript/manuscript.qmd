  ...
  html:
    ...
    other-links:
      ...
      - text: GitHub Repository
        href: https://github.com/cbs-lab/face-familiarity-eam
        icon: github
      - text: OSF Repository
...
We report how we determined our sample size, all data exclusions (if any), all manipulations, and all measures [@simonsConstraintsGeneralityCOG2017].
...
The parameters were sufficiently well-recovered to suggest the combination of data and design were a reasonable choice (See Supplementary Materials).
...
However, this cutoff value led to the removal of 59% of the trials of one participant.
...
The stimuli consisted of images selected from two different data sets of face images: the Face Research Lab London Set [@debruinefacelab2017] and the Color FERET Database (<https://www.nist.gov/itl/products-and-services/color-feret-database>).
...
After 4 pilot experiments, we removed 27 identities (21 from the Face Research Lab London Set and 6 from the Color FERET Database) due to the presence of identifiable features (i.e. skin marks, make-up...).
In total, the data set of face images used in Experiment 1 contained 756 images: one set of three colour face images and one set of three gray scaled face images for each of the 126 identities.

### Material

Stimuli were presented on the screen of a MacBook Pro (Apple M2 Pro, macOS 13 Ventura) and the experiment was run on Psychopy Coder (version: 2022.5, @peircePsychoPy2ExperimentsBehavior2019).
...
One familiarization trial consisted of the presentation of 6 face images, one after the other, depicting the same identity but varying in viewing points (3/4 left view, frontal view and 3/4 right view) and the colorimetry (colour image, gray scale image).
...
The list of the attributions as well as the URL links to all the pictures can be found on OSF (<https://osf.io/65bt2/overview>).
...
Chains convergence diagnostics, as well as priors distributions and predictive checks can be found in Supplementary Materials.
