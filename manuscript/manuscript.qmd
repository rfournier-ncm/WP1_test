...
pkgs <- c(
  "tidyverse", "RColorBrewer", "patchwork", "gtsummary", "paletteer", "eeptools", 
  "here", "gridExtra", "EMC2", "tidybayes", "tinytable", "osfr"
)
vapply(
...
participant_summary <- bind_rows(
  tibble(
    ...
    Setting                  = "Lab",
    Started                  = excl_exp1$started,
    Withdrew                 = excl_exp1$withdrew,
  ...
  tibble(
    ...
    Setting                  = "Online",
    Started                  = excl_exp2$started,
    Withdrew                 = excl_exp2$withdrew,
  ...
  tibble(
    ...
    Setting                  = "Lab",
    Started                  = excl_exp3$started,
    Withdrew                 = excl_exp3$withdrew,
  ...
  tibble(
    ...
    Setting                  = "Online",
    Started                  = excl_exp4$started,
    Withdrew                 = excl_exp4$withdrew,
...
# Exp 1
started_exp1        <- as.integer(exp1_row$Started)
withdrew_exp1       <- as.integer(exp1_row$Withdrew)
...
# Exp 2
started_exp2        <- as.integer(exp2_row$Started)
withdrew_exp2       <- as.integer(exp2_row$Withdrew)
...
# Exp 3
started_exp3         <- as.integer(exp3_row$Started)
withdrew_exp3        <- as.integer(exp3_row$Withdrew)
...
# Exp 4
started_exp4         <- as.integer(exp4_row$Started)
withdrew_exp4        <- as.integer(exp4_row$Withdrew)
...
All participant were recruited on the Prolific platform (<https://www.prolific.com>). Regarding the participants recruitment criteria established, participants had to be located in the United Kingdom or in the United States. Participants must be between 18-65 years old, with normal or corrected-to-normal vision. They must fluently speak English. Furthermore, Prolific offers the option to chose the approval rate of the participants willing to take part in the study. The approval rate is the percentage for which participants has been approved in previous experiment. A approval rate between 95% and 100% was established in our study to ensure data quality. `r started_exp2` participants started the experiment. After reading the inform consent, `r withdrew_exp2` participants decided to not continue the experimental procedure and withdraw from the experiment. In the end, `r completed_exp2` participants completed the experiment and gave their informed consent. Following our preregistration exclusion criterion, `r exclude_rt_exp2` participants were excluded because their percentage of missed trials was higher lower than 25% and `r exclude_acc_exp2` was removed because the overall accuracy was lower than 55%. In the end, the data of `r final_n_exp2` participants (`r male_exp2` men and `r female_exp2` women) was retained for the analysis and the LBA modeling. Ages ranged from `r min_age_exp2` to `r max_age_exp2` ($M_{age} =$ `r mean_age_exp2`, $SD_{age} =$ `r sd_age_exp2`). Following Prolific payment principles, each participant received 9£ for the completion of the study. This experiment was accepted by the ethics committee of the Federal Institute of Technology (ETH) Zurich.
...
All participant were recruited using either an online recruiting platform (<https://marktplatz.uzhalumni.ch>) or via a mailing list dedicated to students from the Department of Psychology of the University of Zurich. `r started_exp3` healthy participants took part in Experiment 3. Based on our preregistration criterion, 3 participants were excluded from the data analysis: `r over_95_exp3` of them had an overall recognition accuracy larger than 95% and `r under_55_exp3` of them had a overall accuracy lower than 55% (chance at 50%). We deviated from our preregistration in one way. Since this experiment was conducted to investigate how highly familiar faces affect the computational processes of face recognition, we had to remove `r exclude_ratings_exp3` more participants who did not show a level of familiarity high enough with the presented faces in the first part of the experiment. This scenario did not occur during the pilot experiments we conducted and thus was not part of our preregistration. In the end, the data of `r final_n_exp3` participants (`r male_exp3` men and `r female_exp3` women) was retained for the analysis and the LBA modeling. Ages ranged from `r min_age_exp3` to `r max_age_exp3` years old ($M_{age} =$ `r mean_age_exp3`, $SD_{age} =$ `r sd_age_exp3`). All participants reported normal or corrected-to-normal vision and received payment (25 CHF) for participating in the experiment. This experiment was accepted by the ethics committee of the Federal Institute of Technology Zurich (ETHZ), and all participant gave their informed consent to participate in the study.
...
All participant were recruited on the Prolific platform (<https://www.prolific.com>). Regarding the participants recruitment criteria established, participants had to be located in the United Kingdom or in the United States. Participants must be between 18-65 years old, with normal or corrected-to-normal vision. They must fluently speak English. An approval rate between 95% and 100% was established in our study to ensure data quality. `r started_exp4` participants started the experiment. After reading the inform consent, `r withdrew_exp4` participants decided to not continue the experimental procedure and withdraw from the experiment. `r completed_exp4` participants completed the experiment. Following our preregistration exclusion criterion, `r exclude_rt_exp4` participant was excluded because the percentage of missed trials was higher than 25% and `r exclude_acc_exp4` were removed because the overall accuracy was lower than 55%. Furthermore, `r exclude_ratings_exp4` did not show a level of familiarity high enough with the presented faces in the first part of the experiment. In the end, the data of `r final_n_exp4` participants (`r male_exp4` men and `r female_exp4` women) was retained for further analysis and the LBA modeling. Ages ranged from `r min_age_exp4` to `r max_age_exp4` ($M_{age} =$ `r mean_age_exp4`, $SD_{age} =$ `r sd_age_exp4`). Following Prolific payment principles, each participant received 9£ for the completion of the study. This experiment was accepted by the ethics committee of the Federal Institute of Technology (ETH) Zurich.
