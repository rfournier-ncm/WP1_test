...
```{r}
#Preregistered model
param_1_pid = EMC2::parameters(LBA_exp3_v1,selection="alpha",N = NULL)
...
ggsave("Exp_3/figures/all_params_1.jpeg",
       width = 8, height = 6)
```
...
ggsave("Exp_3/figures/all_params_pid_1.jpeg",
       width = 8, height = 6)
```
...
## save a figure
 ggsave("Exp_3/figures/thresh.jpeg",width = 10, height = 6)
```
...
# save a figure
 ggsave("Exp_3/figures/thresh_1.jpeg",
        width = 21, height = 10)
```
...
# save a figure
ggsave("Exp_3/figures/thresh_2.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("Exp_3/figures/thresh_3.jpeg",
       width = 21, height = 10)
```
...
ggsave("Exp_3/figures/drift_rate_1.jpeg",
        width = 10, height = 6)
```
...
```{r}
p4.1 / p4.2
ggsave("Exp_3/figures/drift_rate_true_false_1.jpeg", 
       width = 16, height = 13)
```
...
# save a figure
ggsave("Exp_3/figures/drift_rat_mini_1.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("Exp_3/figures/drift_rate_pid_1.jpeg",
       width = 15, height = 10)
```
